...
namespace HistorySiteIdentity.Data.Migrations
{
    ...
    [Migration("20200328131510_noNameNew1")]
    partial class noNameNew1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HistorySiteIdentity.Models.Battalion", b =>
                {
                    b.HasOne("HistorySiteIdentity.Models.Regiment", null)
                        .WithMany("Battalions")
            ...
            modelBuilder.Entity("HistorySiteIdentity.Models.Brigade", b =>
                {
                    b.HasOne("HistorySiteIdentity.Models.Division", null)
                        .WithMany("Brigades")
            ...
            modelBuilder.Entity("HistorySiteIdentity.Models.Commander", b =>
                {
                    b.HasOne("HistorySiteIdentity.Models.Army", null)
                        .WithMany("Commanders")
                        .HasForeignKey("ArmyId");

                    b.HasOne("HistorySiteIdentity.Models.Battalion", null)
                        .WithMany("Commanders")
                        .HasForeignKey("BattalionId");

                    b.HasOne("HistorySiteIdentity.Models.BattleFront", null)
                        .WithMany("Commanders")
                        .HasForeignKey("BattleFrontId");

                    b.HasOne("HistorySiteIdentity.Models.Brigade", null)
                        .WithMany("Commanders")
                        .HasForeignKey("BrigadeId");

                    b.HasOne("HistorySiteIdentity.Models.Corps", null)
                        .WithMany("Commanders")
